...
TEST_CASE("f256 matches MPFR for + - * /", "[fltx][f256][precision]")
{
...
TEST_CASE("f256 brute-force random arithmetic matches MPFR within tolerance", "[fltx][f256][precision]")
{
    ...
    std::cout << "f256 comparing: " << count << " random arithmetic cases...\n\n";
...
TEST_CASE("f256 sin matches MPFR for fixed values", "[fltx][f256][precision][transcendental]")
{
...
TEST_CASE("f256 sin matches MPFR on random reduced-range inputs", "[fltx][f256][precision][transcendental]")
{
    std::mt19937_64 rng{ 1ull };
    ...
    std::cout << "f256 comparing: " << count << " random reduced-range sin cases...\n\n";
...
TEST_CASE("f256 sin matches MPFR on random range-reduced inputs", "[fltx][f256][precision][transcendental]")
{
    std::mt19937_64 rng{ 1ull };
    ...
    std::cout << "f256 comparing: " << count << " random range-reduced sin cases...\n\n";
...
TEST_CASE("f256 cos matches MPFR for fixed values", "[fltx][f256][precision][transcendental]")
{
    const mpfr_ref pi = pi_ref();
    const mpfr_ref half_pi = pi / 2;
    const mpfr_ref quarter_pi = pi / 4;
...
TEST_CASE("f256 cos matches MPFR on random reduced-range inputs", "[fltx][f256][precision][transcendental]")
{
    std::mt19937_64 rng{ 1ull };
    ...
    const mpfr_ref abs_tolerance{ "1e-67" };
    const mpfr_ref rel_tolerance{ "5e-61" };
    std::cout << "f256 comparing: " << count << " random reduced-range cos cases...\n\n";
...
TEST_CASE("f256 cos matches MPFR on random range-reduced inputs", "[fltx][f256][precision][transcendental]")
{
    std::mt19937_64 rng{ 1ull };
    ...
    const mpfr_ref abs_tolerance{ "3e-60" };
    const mpfr_ref rel_tolerance{ "6e-59" };
    std::cout << "f256 comparing: " << count << " random range-reduced cos cases...\n\n";

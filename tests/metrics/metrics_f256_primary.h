...
namespace bl::test::metrics::f256_primary
{
    ...
    constexpr std::size_t random_sample_count = config::f256_primary_random_sample_count;
    ...
    {
        benchmark_sink = benchmark_sink + value.x0;
    }
    ...
    {
        benchmark_sink = benchmark_sink + value[0];
    }

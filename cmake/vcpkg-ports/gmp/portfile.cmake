...
set(gmp_cxx_option --enable-cxx)
if(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "Emscripten")
    set(gmp_cxx_option --disable-cxx)
endif()
...
if(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "Emscripten" AND VCPKG_HOST_IS_WINDOWS)
    foreach(build_type IN ITEMS dbg rel)

...
namespace detail::_f128
{
    ...
    BL_FORCE_INLINE constexpr void sincos_kernel_pi64_reduced(const f128_s& x, f128_s& s_out, f128_s& c_out)
    {
        ...
        const f128_s a = mul_double_inline(pi, static_cast<double>(k) * 0.015625);
    ...
    BL_FORCE_INLINE constexpr f128_s _atan(const f128_s& x)
    {
        ...
        if (isinf(x))  return signbit_constexpr(x.hi) ? -pi_2 : pi_2;
    ...
    BL_FORCE_INLINE constexpr f128_s _asin(const f128_s& x)
    {
        ...
        if (ax <= f128_s{ 0.5 })
            return _atan(div_inline(x, sqrt(sub_inline(f128_s{ 1.0 }, mul_inline(x, x)))));

        const f128_s t = sqrt(div_inline(sub_double_inline(1.0, ax), add_double_inline(ax, 1.0)));
    ...
    BL_FORCE_INLINE constexpr bool try_round_to_signed_integer(const f128_s& x, bool ties_to_even, SignedInt& out) noexcept
    {
        ...
        const f128_s abs_frac = abs(frac);
...
[[nodiscard]] BL_FORCE_INLINE constexpr f128 fabs(const f128_s& a) noexcept { return detail::_f128::fabs_impl(a); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 round(const f128_s& a) { return detail::_f128::round_impl(a); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 nearbyint(const f128_s& a) { return detail::_f128::nearbyint_impl(a); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 rint(const f128_s& x) { return detail::_f128::rint_impl(x); }
[[nodiscard]] BL_FORCE_INLINE constexpr long lround(const f128_s& x) { BL_CONSTEXPR_RUNTIME_DISPATCH(detail::_f128::lround_impl(x), detail::_f128_runtime::lround(x)); }
[[nodiscard]] BL_FORCE_INLINE constexpr long long llround(const f128_s& x) { BL_CONSTEXPR_RUNTIME_DISPATCH(detail::_f128::llround_impl(x), detail::_f128_runtime::llround(x)); }
[[nodiscard]] BL_FORCE_INLINE constexpr long lrint(const f128_s& x) { BL_CONSTEXPR_RUNTIME_DISPATCH(detail::_f128::lrint_impl(x), detail::_f128_runtime::lrint(x)); }
[[nodiscard]] BL_FORCE_INLINE constexpr long long llrint(const f128_s& x) { BL_CONSTEXPR_RUNTIME_DISPATCH(detail::_f128::llrint_impl(x), detail::_f128_runtime::llrint(x)); }

[[nodiscard]] BL_FORCE_INLINE constexpr f128 atan(const f128_s& x) { return detail::_f128::atan_impl(x); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 asin(const f128_s& x) { return detail::_f128::asin_impl(x); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 acos(const f128_s& x) { return detail::_f128::acos_impl(x); }

[[nodiscard]] BL_FORCE_INLINE constexpr f128 fma(const f128_s& x, const f128_s& y, const f128_s& z) { return detail::_f128::fma_impl(x, y, z); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 fmin(const f128_s& a, const f128_s& b) { return detail::_f128::fmin_impl(a, b); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 fmax(const f128_s& a, const f128_s& b) { return detail::_f128::fmax_impl(a, b); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 fdim(const f128_s& x, const f128_s& y) { return detail::_f128::fdim_impl(x, y); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 copysign(const f128_s& x, const f128_s& y) { return detail::_f128::copysign_impl(x, y); }

[[nodiscard]] BL_FORCE_INLINE constexpr int ilogb(const f128_s& x) noexcept { return detail::_f128::ilogb_impl(x); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 logb(const f128_s& x) noexcept { return detail::_f128::logb_impl(x); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 scalbn(const f128_s& x, int e) noexcept { return detail::_f128::scalbn_impl(x, e); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 scalbln(const f128_s& x, long e) noexcept { return detail::_f128::scalbln_impl(x, e); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 nexttoward(const f128_s& from, long double to) noexcept { return detail::_f128::nexttoward_impl(from, to); }
[[nodiscard]] BL_FORCE_INLINE constexpr f128 nexttoward(const f128_s& from, const f128_s& to) noexcept { return detail::_f128::nexttoward_impl(from, to); }
...
[[nodiscard]] BL_FORCE_INLINE  constexpr f128_s detail::_f128_constexpr::atan2(const f128_s& y, const f128_s& x)
{
    ...
    {
        if (x.hi < 0.0)
            return signbit_constexpr(y.hi) ? -detail::_f128::pi : detail::_f128::pi;
        return y;
    }
    ...
    if (ax == ay)
    {
        if (x.hi < 0.0)
        {
            return detail::_f128::canonicalize_math_result(
    ...
    if (ax >= ay)
    {
        ...
        if (x.hi < 0.0)
            a = detail::_f128::add_inline(a, (y.hi < 0.0) ? -detail::_f128::pi : detail::_f128::pi);
        return detail::_f128::canonicalize_math_result(a);
    }
...
template<class Vec> requires detail::fp::sincos_vector_assignable<Vec, f128_s>

...
#include "fltx/detail/f256/arithmetic.h"
...
[[nodiscard]] BL_FORCE_INLINE constexpr f256_s operator+(const f256_s& a, const f256_s& b) noexcept
{
    BL_CONSTEXPR_RUNTIME_DISPATCH(
        detail::_f256_constexpr::add_inline(a, b),
...
{
    BL_CONSTEXPR_RUNTIME_DISPATCH(
        detail::_f256_constexpr::sub_inline(a, b),
...
{
    BL_CONSTEXPR_RUNTIME_DISPATCH(
        detail::_f256_constexpr::mul_inline(a, b),
...
{
    BL_CONSTEXPR_RUNTIME_DISPATCH(
        detail::_f256_constexpr::div_inline(a, b),
...
{
    BL_CONSTEXPR_RUNTIME_DISPATCH(
        detail::_f256_constexpr::add_double_inline(a, b),
...
{
    BL_CONSTEXPR_RUNTIME_DISPATCH(
        detail::_f256_constexpr::sub_double_inline(a, b),
...
{
    BL_CONSTEXPR_RUNTIME_DISPATCH(
        detail::_f256_constexpr::mul_double_inline(a, b),
...
{
    BL_CONSTEXPR_RUNTIME_DISPATCH(
        detail::_f256_constexpr::div_double_inline(a, b),

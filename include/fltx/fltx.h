...
namespace bl
{
    ...
    FORCE_INLINE double log_as_double(float a) { return std::log(a); }
    FORCE_INLINE double log_as_double(double a) { return std::log(a); }
    ...
    FORCE_INLINE constexpr f128::operator f256() const noexcept { return f256{ hi, lo, 0.0, 0.0 }; }

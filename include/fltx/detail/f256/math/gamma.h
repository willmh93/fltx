/**
 * fltx/detail/f256/math/gamma.h - gamma implementation details.
 *
 * f256 gamma/lgamma recurrence and asymptotic implementations.
 *
...
namespace detail::_f256
{
    ...
    BL_NO_INLINE constexpr f256_s lgamma_stirling_asymptotic(const f256_s& z) noexcept
    {
        ...
        return add_eval(
            add_eval(mul_sub_eval(sub_double_eval(z, 0.5), detail::_f256_constexpr::log(z), z), half_log_two_pi),
            series);
    }
    ...
    BL_NO_INLINE constexpr f256_s lgamma_positive_recurrence(const f256_s& x) noexcept
    {
        ...
        return sub_mul_double_eval(
            sub_eval(lgamma_stirling_asymptotic(z), detail::_f256_constexpr::log(product)),
...
[[nodiscard]] BL_FORCE_INLINE constexpr f256_s detail::_f256_constexpr::lgamma(const f256_s& x)
{
    ...
    const f256_s sinpix = detail::_f256_constexpr::sin(mul_inline(std::numbers::pi_v<f256_s>, x));
    if (iszero(sinpix))
        return std::numeric_limits<f256_s>::infinity();

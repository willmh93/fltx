...
[[nodiscard]] BL_FORCE_INLINE constexpr long detail::_f256_constexpr::lround(const f256_s& x)
{
    return detail::_f256::to_signed_integer_or_zero<long>(detail::_f256::round_half_away_zero(x));
}

[[nodiscard]] BL_FORCE_INLINE constexpr long long detail::_f256_constexpr::llround(const f256_s& x)
{
    return detail::_f256::to_signed_integer_or_zero<long long>(detail::_f256::round_half_away_zero(x));
}

[[nodiscard]] BL_FORCE_INLINE constexpr long detail::_f256_constexpr::lrint(const f256_s& x)
{
    return detail::_f256::to_signed_integer_or_zero<long>(detail::_f256_constexpr::nearbyint(x));
}

[[nodiscard]] BL_FORCE_INLINE constexpr long long detail::_f256_constexpr::llrint(const f256_s& x)
{

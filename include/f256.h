...
namespace detail::_f256
{
    ...
    // lightweight double-double type to avoid dragging in f128.h
    struct dd_scalar
    {
        double hi, lo;
    };
...
BL_FORCE_INLINE constexpr f256_s operator+(const f256_s& a, const f128_s& b) noexcept;
BL_FORCE_INLINE constexpr f256_s operator-(const f256_s& a, const f128_s& b) noexcept;
BL_FORCE_INLINE constexpr f256_s operator*(const f256_s& a, const f128_s& b) noexcept;
BL_FORCE_INLINE constexpr f256_s operator/(const f256_s& a, const f128_s& b) noexcept;

BL_FORCE_INLINE constexpr f256_s operator+(const f128_s& a, const f256_s& b) noexcept;
BL_FORCE_INLINE constexpr f256_s operator-(const f128_s& a, const f256_s& b) noexcept;
BL_FORCE_INLINE constexpr f256_s operator*(const f128_s& a, const f256_s& b) noexcept;
BL_FORCE_INLINE constexpr f256_s operator/(const f128_s& a, const f256_s& b) noexcept;
...
struct f256_s
{
    ...
    BL_FORCE_INLINE constexpr f256_s& operator+=(int64_t rhs) noexcept
    {
        ...
        else { const auto value = detail::_f256::integer_to_double_double(rhs); *this = detail::_f256::add_dd(*this, value); }
        return *this;
    }
    BL_FORCE_INLINE constexpr f256_s& operator-=(int64_t rhs) noexcept
    {
        if (detail::fp::integer_fits_exact_double(rhs))
            *this = *this - static_cast<double>(rhs);
        else { const auto value = detail::_f256::integer_to_double_double(rhs); *this = detail::_f256::sub_dd(*this, value); }
        return *this;
    }
    BL_FORCE_INLINE constexpr f256_s& operator*=(int64_t rhs) noexcept
    {
        if (detail::fp::integer_fits_exact_double(rhs))
            *this = *this * static_cast<double>(rhs);
        else { const auto value = detail::_f256::integer_to_double_double(rhs); *this = detail::_f256::mul_dd(*this, value); }
        return *this;
    }
    BL_FORCE_INLINE constexpr f256_s& operator/=(int64_t rhs) noexcept
    {
        if (detail::fp::integer_fits_exact_double(rhs))
            *this = *this / static_cast<double>(rhs);
        else { const auto value = detail::_f256::integer_to_double_double(rhs); *this = detail::_f256::div_dd(*this, value); }
        return *this;
    }
    ...
    template<class T, std::enable_if_t<std::is_integral_v<T>&& std::is_signed_v<T> && (sizeof(T) < 8), int> = 0>
    BL_FORCE_INLINE constexpr f256_s& operator+=(T rhs) noexcept { return (*this += static_cast<int64_t>(rhs)); }
    template<class T, std::enable_if_t<std::is_integral_v<T>&& std::is_signed_v<T> && (sizeof(T) < 8), int> = 0>
    BL_FORCE_INLINE constexpr f256_s& operator-=(T rhs) noexcept { return (*this -= static_cast<int64_t>(rhs)); }
    template<class T, std::enable_if_t<std::is_integral_v<T>&& std::is_signed_v<T> && (sizeof(T) < 8), int> = 0>
    BL_FORCE_INLINE constexpr f256_s& operator*=(T rhs) noexcept { return (*this *= static_cast<int64_t>(rhs)); }
    ...
    template<class T, std::enable_if_t<std::is_integral_v<T>&& std::is_unsigned_v<T> && (sizeof(T) < 8), int> = 0>
    BL_FORCE_INLINE constexpr f256_s& operator+=(T rhs) noexcept { return (*this += static_cast<uint64_t>(rhs)); }
    template<class T, std::enable_if_t<std::is_integral_v<T>&& std::is_unsigned_v<T> && (sizeof(T) < 8), int> = 0>
    BL_FORCE_INLINE constexpr f256_s& operator-=(T rhs) noexcept { return (*this -= static_cast<uint64_t>(rhs)); }
    template<class T, std::enable_if_t<std::is_integral_v<T>&& std::is_unsigned_v<T> && (sizeof(T) < 8), int> = 0>
    BL_FORCE_INLINE constexpr f256_s& operator*=(T rhs) noexcept { return (*this *= static_cast<uint64_t>(rhs)); }
...
namespace detail::_f256_runtime
{
    ...
    // f256 <=> internal double-double operations
    ...
    [[nodiscard]] BL_NO_INLINE f256_s mul_add_mul_sub_mul(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, const f256_s& f) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_sub_mul_add_mul(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, const f256_s& f) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_sub_mul_sub_mul(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, const f256_s& f) noexcept;
    ...
    [[nodiscard]] BL_NO_INLINE f256_s mul_add_mul_add_mul_sub_mul(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, const f256_s& f, const f256_s& g, const f256_s& h) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_add_mul_sub_mul_add_mul(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, const f256_s& f, const f256_s& g, const f256_s& h) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_add_mul_sub_mul_sub_mul(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, const f256_s& f, const f256_s& g, const f256_s& h) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_sub_mul_add_mul_add_mul(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, const f256_s& f, const f256_s& g, const f256_s& h) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_sub_mul_add_mul_sub_mul(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, const f256_s& f, const f256_s& g, const f256_s& h) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_sub_mul_sub_mul_add_mul(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, const f256_s& f, const f256_s& g, const f256_s& h) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_sub_mul_sub_mul_sub_mul(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, const f256_s& f, const f256_s& g, const f256_s& h) noexcept;
    ...
    [[nodiscard]] BL_NO_INLINE f256_s mul_add_mul_double(const f256_s& a, const f256_s& b, const f256_s& c, double scalar) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_sub_mul_double(const f256_s& a, const f256_s& b, const f256_s& c, double scalar) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_double_sub_mul(const f256_s& value, double scalar, const f256_s& a, const f256_s& b) noexcept;
    ...
    [[nodiscard]] BL_NO_INLINE f256_s mul_add_mul_add_mul_double(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, double scalar) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_add_mul_sub_mul_double(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, double scalar) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_sub_mul_add_mul_double(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, double scalar) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_sub_mul_sub_mul_double(const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d, const f256_s& e, double scalar) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_double_sub_mul_add_mul(const f256_s& value, double scalar, const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s mul_double_sub_mul_sub_mul(const f256_s& value, double scalar, const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d) noexcept;
    ...
    [[nodiscard]] BL_NO_INLINE f256_s div_mul_add_mul(const f256_s& numerator, const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d) noexcept;
    [[nodiscard]] BL_NO_INLINE f256_s div_mul_sub_mul(const f256_s& numerator, const f256_s& a, const f256_s& b, const f256_s& c, const f256_s& d) noexcept;
...
namespace detail::_f256
{
    ...
    [[nodiscard]] BL_FORCE_INLINE constexpr f256_s add_dd(const f256_s& a, dd_scalar b) noexcept
    {
        BL_CONSTEXPR_RUNTIME_DISPATCH(add_inline(a, f256_s{ b.hi, b.lo }), detail::_f256_runtime::add_dd(a, b));
    }
    [[nodiscard]] BL_FORCE_INLINE constexpr f256_s sub_dd(const f256_s& a, dd_scalar b) noexcept
    {
        BL_CONSTEXPR_RUNTIME_DISPATCH(sub_inline(a, f256_s{ b.hi, b.lo }), detail::_f256_runtime::sub_dd(a, b));
    }
    [[nodiscard]] BL_FORCE_INLINE constexpr f256_s sub_dd(dd_scalar a, const f256_s& b) noexcept
    {
        BL_CONSTEXPR_RUNTIME_DISPATCH(sub_inline(f256_s{ a.hi, a.lo }, b), detail::_f256_runtime::sub_dd(a, b));
    }
    [[nodiscard]] BL_FORCE_INLINE constexpr f256_s mul_dd(const f256_s& a, dd_scalar b) noexcept
    {
        BL_CONSTEXPR_RUNTIME_DISPATCH(mul_inline(a, f256_s{ b.hi, b.lo }), detail::_f256_runtime::mul_dd(a, b));
    }
    [[nodiscard]] BL_FORCE_INLINE constexpr f256_s div_dd(const f256_s& a, dd_scalar b) noexcept
    {
        BL_CONSTEXPR_RUNTIME_DISPATCH(div_inline(a, f256_s{ b.hi, b.lo }), detail::_f256_runtime::div_dd(a, b));
    }
    [[nodiscard]] BL_FORCE_INLINE constexpr f256_s div_dd(dd_scalar a, const f256_s& b) noexcept
    {
        BL_CONSTEXPR_RUNTIME_DISPATCH(div_inline(f256_s{ a.hi, a.lo }, b), detail::_f256_runtime::div_dd(a, b));
    }
}

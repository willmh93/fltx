...
template<> struct std::numeric_limits<bl::f128>
{
    static constexpr bool is_specialized = true;

    // limits
    static constexpr bl::f128 min()            noexcept { return { numeric_limits<double>::min(), 0.0 }; }
    static constexpr bl::f128 max()            noexcept { return { numeric_limits<double>::max(), -numeric_limits<double>::epsilon() }; }
    static constexpr bl::f128 lowest()         noexcept { return { -numeric_limits<double>::max(),  numeric_limits<double>::epsilon() }; }
    static constexpr bl::f128 highest()        noexcept { return { numeric_limits<double>::max(), -numeric_limits<double>::epsilon() }; }

    // special values                        
    static constexpr bl::f128 epsilon()        noexcept { return { 1.232595164407831e-32, 0.0 }; } // ~2^-106, a single ulp of double-double
    static constexpr bl::f128 round_error()    noexcept { return { 0.5, 0.0 }; }
    static constexpr bl::f128 infinity()       noexcept { return { numeric_limits<double>::infinity(), 0.0 }; }
    static constexpr bl::f128 quiet_NaN()      noexcept { return { numeric_limits<double>::quiet_NaN(), 0.0 }; }
    static constexpr bl::f128 signaling_NaN()  noexcept { return { numeric_limits<double>::signaling_NaN(), 0.0 }; }
    static constexpr bl::f128 denorm_min()     noexcept { return { numeric_limits<double>::denorm_min(), 0.0 }; }
...
{
    template<> inline constexpr bl::f128 e_v<bl::f128>          = { 0x1.5bf0a8b145769p+1,  0x1.4d57ee2b1013ap-53 };
    template<> inline constexpr bl::f128 log2e_v<bl::f128>      = { 0x1.71547652b82fep+0,  0x1.777d0ffda0d24p-56 };
    template<> inline constexpr bl::f128 log10e_v<bl::f128>     = { 0x1.bcb7b1526e50ep-2,  0x1.95355baaafad3p-57 };
    template<> inline constexpr bl::f128 pi_v<bl::f128>         = { 0x1.921fb54442d18p+1,  0x1.1a62633145c07p-53 };
    template<> inline constexpr bl::f128 inv_pi_v<bl::f128>     = { 0x1.45f306dc9c883p-2, -0x1.6b01ec5417056p-56 };
    template<> inline constexpr bl::f128 inv_sqrtpi_v<bl::f128> = { 0x1.20dd750429b6dp-1,  0x1.1ae3a914fed80p-57 };
    template<> inline constexpr bl::f128 ln2_v<bl::f128>        = { 0x1.62e42fefa39efp-1,  0x1.abc9e3b39803fp-56 };
    template<> inline constexpr bl::f128 ln10_v<bl::f128>       = { 0x1.26bb1bbb55516p+1, -0x1.f48ad494ea3e9p-53 };
    template<> inline constexpr bl::f128 sqrt2_v<bl::f128>      = { 0x1.6a09e667f3bcdp+0, -0x1.bdd3413b26456p-54 };
    template<> inline constexpr bl::f128 sqrt3_v<bl::f128>      = { 0x1.bb67ae8584caap+0,  0x1.cec95d0b5c1e3p-54 };
    template<> inline constexpr bl::f128 inv_sqrt3_v<bl::f128>  = { 0x1.279a74590331cp-1,  0x1.34863e0792bedp-55 };
    template<> inline constexpr bl::f128 egamma_v<bl::f128>     = { 0x1.2788cfc6fb619p-1, -0x1.6cb90701fbfabp-58 };
    template<> inline constexpr bl::f128 phi_v<bl::f128>        = { 0x1.9e3779b97f4a8p+0, -0x1.f506319fcfd19p-55 };
}
...
{
    inline constexpr f128 e          = std::numbers::e_v<f128>;
    inline constexpr f128 log2e      = std::numbers::log2e_v<f128>;
    inline constexpr f128 log10e     = std::numbers::log10e_v<f128>;
    inline constexpr f128 pi         = std::numbers::pi_v<f128>;
    inline constexpr f128 inv_pi     = std::numbers::inv_pi_v<f128>;
    inline constexpr f128 inv_sqrtpi = std::numbers::inv_sqrtpi_v<f128>;
    inline constexpr f128 ln2        = std::numbers::ln2_v<f128>;
    inline constexpr f128 ln10       = std::numbers::ln10_v<f128>;
    inline constexpr f128 sqrt2      = std::numbers::sqrt2_v<f128>;
    inline constexpr f128 sqrt3      = std::numbers::sqrt3_v<f128>;
    inline constexpr f128 inv_sqrt3  = std::numbers::inv_sqrt3_v<f128>;
    inline constexpr f128 egamma     = std::numbers::egamma_v<f128>;
    inline constexpr f128 phi        = std::numbers::phi_v<f128>;
    ...
    inline constexpr f128 inv_ln2   = log2e;
    inline constexpr f128 inv_ln10  = log10e;
    inline constexpr f128 sqrt_half = { 0x1.6a09e667f3bcdp-1, -0x1.bdd3413b26456p-55 };
}
namespace _f128_detail
{
